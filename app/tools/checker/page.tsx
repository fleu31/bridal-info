  ...
  return (<div>
    ...
    <main className="container py-10 space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-3">
        ...
        <div><label className="text-sm">ダウンタイム許容</label><select value={dt} onChange={e=>setDt(e.target.value)} className="mt-1 w-full border p-2 rounded-none"><option>ほぼ不可</option><option>軽度なら可（1–2日）</option><option>中等度まで可（3–5日）</option></select></div>
      </div>
